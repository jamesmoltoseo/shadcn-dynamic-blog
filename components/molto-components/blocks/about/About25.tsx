          ...
          <div className="row gx-md-8 gx-xl-12 gy-6 align-items-center">
            <div className="col-md-8 col-lg-6 order-lg-2 mx-auto">
              <div className="img-mask mask-2">
                <Image layout="responsive" width={1000} height={850} src="/img/photos/about30.jpg" alt="" />
              </div>
            </div>
            ...
            <div className="col-lg-6">
              ...
              <NextLink title="Learn More" href="#" className="btn btn-primary rounded-pill mt-2 d-inline" />
            </div>
          </div>
