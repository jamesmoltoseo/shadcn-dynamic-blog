          ...
          <div className="row gx-md-5 gy-5">
            <div className="col-md-6">
              <figure className="rounded">
                <Image src="/img/photos/g14.jpg" srcSet="/img/photos/g14@2x.jpg 2x" alt="" />
              </figure>
            </div>

            <div className="col-md-6 align-self-end">
              <figure className="rounded">
                <Image src="/img/photos/g15.jpg" srcSet="/img/photos/g15@2x.jpg 2x" alt="" />
              </figure>
            </div>

            <div className="col-12">
              <figure className="rounded mx-md-5">
                <Image src="/img/photos/g16.jpg" srcSet="/img/photos/g16@2x.jpg 2x" alt="" />
              </figure>
            </div>
          </div>
        </div>
