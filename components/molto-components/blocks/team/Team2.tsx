  ...
  return (
    <div className="row gx-lg-8 gx-xl-12 gy-10 mb-16 mb-md-17 mb-xl-20 align-items-center">
      <div className="col-lg-4">
        <h2 className="fs-15 text-uppercase mb-3">Meet the Team</h2>
        ...
        <NextLink alt="See All Members" title="See All Members" href="#" className="btn btn-primary rounded-pill mt-3" />
      </div>
