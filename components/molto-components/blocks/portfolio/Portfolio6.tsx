...
href="#">
                <a>
                  <figure className="lift rounded mb-6">
                    <Image src="/img/photos/rp2.jpg" srcSet="/img/photos/rp2@2x.jpg 2x" alt="demo" />
                  </figure>
                </a>
              </Link>
...
href="#">
                <a>
                  <figure className="lift rounded mb-6">
                    <Image src="/img/photos/rp1.jpg" srcSet="/img/photos/rp1@2x.jpg 2x" alt="" />
                  </figure>
                </a>
              </Link>
...
href="#">
                <a>
                  <figure className="lift rounded mb-6">
                    <Image src="/img/photos/rp3.jpg" srcSet="/img/photos/rp3@2x.jpg 2x" alt="" />
                  </figure>
                </a>
              </Link>
